...
bot.object_collect_delay = 600
bot.auto_collect = false
function GonWebhook(Wartex)
    local script = [[
    $webHookUrl = "]]..WebhookUrl..[["
    $thumbnailObject = [PSCustomObject]@{
    url = "https://komikkamvret.com/wp-content/uploads/2021/04/Pus-Nyangami-Headbang.gif"
    }
    $color = Get-Random -Minimum 0 -Maximum 16777215
    $title = '@872027223337603073 - Rotation'
    $description = "**]]..Wartex..[[**"
  
    $footer = [PSCustomObject]@{
        icon_url = "https://cdn.discordapp.com/emojis/978628955907170314.gif?size=96&quality=lossless"
        text = "]].."Wartex#7171 | Date : "..(os.date"%d/%m/%y":upper().." Hour : ")..os.date("%I")..":"..os.date("%M").." "..os.date("%p"):upper()..[["
    }
